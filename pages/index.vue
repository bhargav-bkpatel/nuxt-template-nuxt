        ...
        <div class="home-content1">
          ...
          <h1 class="home-text10">
            <span class="home-text11">
              Pay and get paid
              <span v-html="rawcp74"></span>
            </span>
            <span class="home-text12">
              faster
              <span v-html="rawoslx"></span>
            </span>
    ...
    <div class="home-section2 section-container">
      <div class="home-max-width4 max-width">
        ...
        <div class="home-content3">
          ...
          <div class="home-step">
            <div class="home-number"><span class="home-text24">1</span></div>
          ...
          <div class="home-step1">
            <div class="home-number1"><span class="home-text26">2</span></div>
          ...
          <div class="home-step2">
            <div class="home-number2"><span class="home-text28">3</span></div>
            <div class="home-container06">
              <span class="home-title3">Link your existing credit cards</span>
    ...
    <div class="section-container">
      <div class="home-max-width5 max-width">
        ...
        <div class="home-cards-container">
          <app-card rootClassName="card-root-class-name2"></app-card>
          <app-card
            text="Personal"
          ...
          <div class="home-questions">
            ...
            <div data-role="Accordion" class="question">
              <div data-type="accordion-header" class="home-trigger">
                <span class="home-text39">Is this a Free or Paid service?</span>
            ...
            <div data-role="Accordion" class="question">
              <div data-type="accordion-header" class="home-trigger1">
                <span class="home-text41">Do you operate in United Stated?</span>
        ...
        <div class="home-banner">
          ...
          <span class="home-text54">
            <span>
              ...
              <span v-html="raw1cr5"></span>
            </span>
            <br />
            <span>
              aliqua dolor do amet sint.
              <span v-html="rawp43o"></span>
            </span>
          </span>
          <div class="home-btns">
